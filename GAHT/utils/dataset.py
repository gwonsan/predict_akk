...
def load_mat_hsi(dataset_name, dataset_dir,dataset_file_name):
    ...
    if (dataset_name == 'gs'):
        # with h5py.File(os.path.join(dataset_dir,dataset_file_name), 'r') as f:
        #     image = f['input'][:]  # (3000, 3000, 150)
        #     gt = f['gt'][:]
        # labels = [
        #     "Undefined",
        #     "AKK",
