...
parser.add_argument('--inference_model', type=str, default='./results/models.pkl', help='inference model')
...
def main():
    wandb.init(project="DSNet", name=f"{args.dataset}_{args.model_name}_p{args.patches}")
